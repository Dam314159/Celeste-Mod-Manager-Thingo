...
void init() {
    ...
    if (settingsFile.is_open()) {
        ...
        try {
            ...
            logger::error({"SettingsHandler.cpp", "init"}, "ERROR: Settings file could not be loaded. Settings file may be corrupted or malformed.");
        ...
        if (settingsFile.is_open()) {
            ...
            logger::log({"SettingsHandler.cpp", "init"}, "Settings file created and loaded.");
        } else {
            logger::warn({"SettingsHandler.cpp", "init"}, "Settings file not created. Using default settings...");
        }
        settingsFile.close();
    }
}
